pipeline {
    ...
    stages {
        ...
        stage ('Deploy Frontend') {
            steps {
                dir('frontend') {
                    git credentialsId: 'github_login', url: 'https://github.com/ivanfsilva/tasks-frontend'
        ...
        stage ('Functional Test') {
            steps {
                dir('functional-test') {
                    git credentialsId: 'github_login', url: 'https://github.com/ivanfsilva/tasks-functional-tests'
                    bat 'mvn test'
                }
            }
        }
